  ...
  return {
    ...
    execute: function () {
      ...
      _export("RecipesSearch", RecipesSearch = (_dec = ccclass('RecipesSearch'), _dec2 = property(EditBox), _dec3 = property(Node), _dec4 = property(_crd && RecipesGenerate === void 0 ? (_reportPossibleCrUseOfRecipesGenerate({
        ...
        // onLoad() {
        //     // 监听输入框的回车事件
        //     this.searchBox.node.on('editing-did-ended', this.onSearch, this);
        // }
        onSearch() {
          var keyword = this.searchBox.string.trim(); // 获取用户输入的关键词

          if (keyword) {
            var searchResults = this.recipesGenerate.searchRecipesByKeyword(keyword); // 调用搜索功能
...
//# sourceMappingURL=e4d61bb2b1ec6f54233a07dd6a74fba39f4e8cc8.js.map