        ...
        constructor() {
          ...
          this.recipeData = {
            recipes: [{
              ...
              details: "    好吃的拌土豆片<br/>" + "<br/>1.去好皮的土豆削成片<br/>" + "<br/>2.水开放土豆片，一分钟捞出浸凉水<br/>" + "<br/>3.花生酱、芝麻酱、温水1：1:1搅拌到浓稠的质地<br/>" + "<br/>4.再加上酱油、醋、蚝油、白糖，一大勺油泼辣子<br/>" + "<br/>5.拌好加入土豆片继续拌<br/>" + "<br/>6.最后撒上芝麻和葱花<br/>"
            }, {
              name: "煎土豆",
              ingredients: ["土豆"],
              seasonings: [],
